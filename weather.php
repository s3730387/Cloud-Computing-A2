...
<body>
    ...
    <div class="container">
        <div class="weather-icon">
            <!-- Icons folder downloaded from: https://github.com/manifestinteractive/weather-underground-icons -->
            <!-- Folders are from weather-underground-icons/dist/icons/ -->
        </div>
        <div class="container">
            <h2 id="text-center">Enter Address: </h2>
            <form method="post" action="/location">
                <input type="text" id="location-input" name="location" class="form-control form-control-lg">
                <br>
